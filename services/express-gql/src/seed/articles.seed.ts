import { IArticle } from "../graphql/types/article/article.interface";
...
export const ARTICLES_SEED_DATA: Array<IArticle> = [
  {
    ...
    urls: ["https://dev.to/atonchev/flawless-and-silent-upgrade-of-the-service-worker-2o95"],
  },
  {
  ...
  },
  {
    ...
    urls: ["https://refactoring.guru/design-patterns/facade", "https://martinfowler.com/articles/microservices.html"],
  },
  {
    ...
    urls: ["https://medium.com/scb-abacus/introduction-to-event-driven-architecture-in-node-js-typescript-354302bc055c"],
  },
  {
  ...
  },
  {
    ...
    urls: ["https://www.netlify.com/blog/2020/06/18/next.js-101-what-you-should-know/"],
  },
];
